...
d3.xml('img/dense.svg', "image/svg+xml", function(xml) {
    document.getElementById("dense").appendChild(xml.documentElement);
});
d3.xml('img/sparse.svg', "image/svg+xml", function(xml) {
    document.getElementById("sparse").appendChild(xml.documentElement);
});
...
d3.xml('img/tr-learncurve.svg', "image/svg+xml", function(xml) {
    document.getElementById("tr-learncurve").appendChild(xml.documentElement);
});
